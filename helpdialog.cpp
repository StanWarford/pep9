...
//    qDebug() << "Selected: " << ui->treeWidget->currentIndex();
    ...
    if ((!isHelpSubCat && row == eWRITING) || parentRow == eWRITING) {
        ...
        if (!isHelpSubCat) {
            ...
            if (row == eFIG432) {
                ui->leftTextEdit->setText(Pep::resToString(":/help/figures/fig0432.peph"));
                ui->rightPepTextEdit->setText(Pep::resToString(":/help/figures/fig0432.pepb"));
                ui->figureLabel->setText("<b>Figure 4.32</b><code>  </code> A machine language program to output the characters <code>Hi</code>.");
                ...
                ui->figureLabel->setText("<b>Figure 4.35</b><code>  </code> A machine language program to add 5 and 3 and output the single-character result.");
                ui->rightPepTextEdit->show();
                ui->rightCppTextEdit->hide();
                ui->copyToSourceButton->setText("Copy to Object");
            }
                ...
                ui->figureLabel->setText("<b>Figure 5.7</b><code>  </code> An assembly language program to add 3 and 5 and output the single-character result. It is the assembly language version of Figure 4.35.");
                ui->rightCppTextEdit->hide();
                ui->rightPepTextEdit->show();
            }
            else if (row == eFIG510) {
